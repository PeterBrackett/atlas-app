...
const ALLOWED_BASIS_KEYS = ['market_opportunity_basis', 'regulatory_complexity_basis', 'distribution_resources_basis', 'languages_required_basis', 'local_presence_required_basis', 'client_servicing_basis', 'consultant_reliant_basis'];
