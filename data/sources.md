...
**Worked example — UK `DB Pension (Govt)`**: a live MMD read of the Government-category "Total DB Assets" figure is approximately £689.6bn. The figure actually used, £393.94bn, is a top-down override aligned to official LGPS (Local Government Pension Scheme) statistics, judged more reliable than the raw S&P sum for this segment specifically. This is the kind of decision recorded on this page rather than left unexplained next to the number.
