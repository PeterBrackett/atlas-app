...
// These four values come from Application Settings on the Static Web App resource,
// never hard-coded here and never committed to the repo.
...
// The folder in the Atlas SharePoint site's default document library where the
// per-country JSON data files live. Peter uploads/edits files here directly;
// nothing about updating data requires touching code or GitHub.
...
app.http('getData', {
  ...
  handler: async (request, context) => {
    ...
    // Basic guard: only allow simple alphanumeric country identifiers,
    // since this maps directly to a filename fetched from SharePoint.
